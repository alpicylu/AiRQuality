...
pojedynczego pomiaru wynoszącym 75B oraz pobierając pomiary z 4 czujników co 5 min okazuje się, że miejsce w bazie skończy się w ciągu około 2300 dni
($\approx$ 6 lat) od momentu uruchomienia pustej bazy danych. Nie mniej jednak w następnej fazie projektu dokona się próby ustawienia usuwania najstarszych
rekordów w momencie bliskim przepełnieniu bazy.
