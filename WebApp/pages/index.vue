<template>
    <div class="flex flex-col h-full items-center">
        <div class="w-5/6 sticky top-0 z-10 bg-ext-white">
            <div class="flex flex-initial flex-wrap justify-end items-center bg-ext-primary-1 rounded-full w-full gap-4 my-5 px-10 py-2">
...
import fakeSensorLifeFeed from '~/tests/fakeSensorLiveFeed'
...
const pollingInterval = setInterval(() => {
    ...
    // fakeSensorLifeFeed(fetchedSensorData)
