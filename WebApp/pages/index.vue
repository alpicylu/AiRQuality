<template>
    <div class="flex flex-col h-full items-center">
        <div class="bg-white w-5/6 sticky top-0">
            <div class="flex flex-initial flex-wrap justify-end items-center bg-ext-margins rounded-full w-full my-5 px-10 py-2">
