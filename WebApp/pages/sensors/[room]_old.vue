...
async function getFirstBatchSensorData(){
    ...
    //get the iqrfID of the sensor that corresponds to this room.
    //This API function returns an array of all sensors that match the query, but since only one sensor will
    //match this one, only one will be returned in that array.
