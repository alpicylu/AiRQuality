 ...
 * that do api calls stuff - those and similar functions should accept a JSON object that contains all parameters.
 * That object would then be passed as an argument into a fetch call. This also makes any testing easier, since i can pass any 
